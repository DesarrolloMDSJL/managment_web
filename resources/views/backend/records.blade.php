...
@section('content')
    <section id="basic-input" >       
        <div class="row form-container">
            <div class="col-md-12">
                <user-form
                    :route="'{{ route('admin.security.ct') }}'"
                    :list-menus = "{{ $list_menus}}"            
                >
                </user-form>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <user-table
                                :url-list="'{{ route('admin.security.list') }}'"
                                :url-detail="'{{ route('admin.security.detail') }}'"
                                :url-delete="'{{ route('admin.security.delete') }}'"
                            >
                            </user-table>
                        </div>
                    </div>
